...
3. **Settings** — contact details, social links, accent colour, the footer and
   the contact page. Fill in your phone number here if you want it shown; each
   detail has its own switch for the footer and for the contact page, so you can
   show it in one place and not the other. The browser-tab icon is drawn in your
   accent colour automatically, so there is nothing to upload unless you want
   your own.
