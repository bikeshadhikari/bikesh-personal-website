...
const SETTINGS: Record<string, Record<string, string>> = {
  site: {
    ...
    footer_topics_title: 'Topics',
    footer_contact_title: 'Reach me',
    footer_show_links: '1',
    footer_show_topics: '1',
    footer_show_contact: '1',
    footer_show_social: '1',
    footer_show_rss: '0',
    footer_show_email: '1',
    footer_show_phone: '1',
    footer_show_location: '1',
    footer_show_hours: '0',
    contact_show_email: '1',
    contact_show_phone: '1',
    contact_show_location: '1',
    contact_show_hours: '1',
    contact_show_social: '1',
    contact_show_form: '1',
    contact_show_map: '1',
    footer_copyright: '',
    ...
    pol_intro: 'प्रविधि, शिक्षा, सामाजिक सेवा, युवा नेतृत्व र राजनीतिक अध्ययनलाई जोड्दै अघि बढेको एक युवाको सार्वजनिक यात्रा।',
